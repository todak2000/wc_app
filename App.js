...
import PurchaseItemScreen from './components/MarketComponents/PurchaseItemScreen';
import DonationDetailPage from './components/MarketComponents/DonationDetailPage';
import { AboutPartnerSitePage } from './components/MarketComponents/AboutPartnerSitePage';
  ...
  return (
    <Provider store={store}>
      ...
      <Spinner visible={loading}/>
        ...
        <Stack.Screen 
          name="about_site" 
          component={AboutPartnerSitePage} 
          options={{ headerShown: false} }
        />
